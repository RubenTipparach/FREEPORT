...
echo contoured world instead, with its towns, its builder and the walker.
echo.
echo Left click takes the mouse, Escape gives it back. WASD flies, Shift is
echo faster, Tab toggles the wire.
echo.
