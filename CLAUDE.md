...
```sh
cargo test -p freeport_core                       # 173, the core, about 32 s
...
- `freeport_core`: 173 tests in about 32 s, and `freeport_app` 47 in 3. A 6 m sphere on a 32^3 lattice
...
- **The atlas re-baked on cities ten times bigger and a cut a town may
  ...
  back in 1.8 s. At 170 m towns and no cap it was 1,084 settlements and
